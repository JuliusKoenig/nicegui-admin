...
class BaseSqlModelFieldConverter(BaseFieldConverter):
    def get_converter(self, col_type: Any) -> Callable[..., BaseField]:
        ...
        if converter is not None:
            return converter
        raise NotSupportedColumn(f"Column {col_type} can not be converted automatically. Find the appropriate field manually or provide "
...
class SqlModelFieldConverter(BaseSqlModelFieldConverter):
    ...
    #     return TextAreaField(**self._field_common(*args, **kwargs),
    #                          **self._string_common(*args, **kwargs))

    @converts("Boolean", "BIT")
    def conv_boolean(self, *args: Any, **kwargs: Any) -> BaseField:
        return BooleanField(**self._field_common(*args, **kwargs))
    #
    # @converts("DateTime")
    # def conv_datetime(self, *args: Any, **kwargs: Any) -> BaseField:
    #     return DateTimeField(**self._field_common(*args, **kwargs))
    #
    # @converts("Date")
    # def conv_date(self, *args: Any, **kwargs: Any) -> BaseField:
    #     return DateField(**self._field_common(*args, **kwargs))
    #
    # @converts("Time")
    # def conv_time(self, *args: Any, **kwargs: Any) -> BaseField:
    #     return TimeField(**self._field_common(*args, **kwargs))
    #
    # @converts("Enum")
    ...
    def conv_numeric(self, *args: Any, **kwargs: Any) -> BaseField:
        if isinstance(kwargs["_type"], Float) and not kwargs["_type"].asdecimal:
            return FloatField(**self._field_common(*args, **kwargs))
        return DecimalField(**self._field_common(*args, **kwargs))
    ...
    #         return EnumField(**self._field_common(*args, **kwargs),
    #                          enum=choices,
